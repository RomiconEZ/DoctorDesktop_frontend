      ...
      <>
        {patients.map(patient => (
            <tr key={patient.id} onClick={() => navigate(`/auth/menu/patients/${patient.id}`)}
              ...
              <td className="px-6 py-1 font-semibold text-our-greenish-300">{patient.first_name + ' ' + patient.first_name + ' ' + patient.patronymic}</td>
              <td className="px-6 py-1 text-slate-700">{patient.birthday}</td>
              ...
              <td className="px-6 py-1 text-slate-700">{patient.residenseregion}</td>
                ...
                <td className="px-6 py-1 text-slate-700">{patient.clinic}</td>
            </tr>
        ))}
      </>
  );
